...
<body>
  ...
  <script>{!! \File::get(base_path('vendor/qikker-online/nova-tinymce/resources/js/laravel-filemanager/script.js')) !!}</script>
    ...
    Dropzone.options.uploadForm = {
      ...
      init: function() {
        ...
        this.on('success', function(file, response) {
          var limonada = response
          console.log(response)
          if (Array.isArray(response)) {
            this.defaultOptions.error(file, response[0]);
